    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-50 dark:bg-slate-950 p-4">
      ...
      >
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-slate-800 dark:text-white">CivicTrack</h1>
          <p className="text-slate-500 dark:text-slate-400 mt-2">Welcome back, Citizen</p>
        </div>
        ...
        <div className="mt-6 p-4 bg-slate-100 dark:bg-slate-800 rounded-xl text-xs text-slate-500">
          <p className="font-semibold mb-1">Demo Credentials:</p>
          <p>Admin: admin@civictrack.gov / admin123</p>
        </div>
      </motion.div>
    </div>
  );
